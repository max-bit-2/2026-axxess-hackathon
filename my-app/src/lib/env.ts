...
const disableAuthForDemo =
  (process.env.MEDIVANCE_DISABLE_AUTH ?? "true").toLowerCase() !== "false";
const failClosedExternalChecks =
  process.env.FAIL_CLOSED_EXTERNAL_CHECKS !== undefined
    ? process.env.FAIL_CLOSED_EXTERNAL_CHECKS.toLowerCase() !== "false"
    : !disableAuthForDemo;
